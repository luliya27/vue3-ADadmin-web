<template>
    <div class="computer-list-page">
        ...
        <!-- 新增 / 修改 / 刪除防呆 -->
        <CreateComputerModal v-if="showCreate" :ou-options="ouOptions" @close="showCreate = false"
            @submit="submitCreate" />
        <EditComputerModal v-if="showEdit && editing" :computer="editing" :ou-options="ouOptions" @close="closeEdit"
