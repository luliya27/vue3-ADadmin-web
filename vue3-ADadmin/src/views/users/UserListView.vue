<template>
    <div class="user-list-page">
                ...
                <div class="toolbar-item-right">
                    <div class="status-filters">
                        ...
                        <input class="search-box" v-model.trim="keyword" type="text"
                            placeholder="搜尋帳號 / 顯示名稱 / Email / 部門" />
                    </div>
                </div>
            </div>
        </section>
            ...
            <table class="user-table">
                ...
                <tbody>
                    ...
                    <tr v-for="user in filteredUsers" :key="user.username">
                        ...
                        <!-- 狀態 -->
                        <td v-else><span class="muted">未指定</span></td>
                        <!-- 狀態 -->
                        <td>
        ...
        <!-- <CreateUserModal v-if="showCreate" :ous="ous" :groups="groups" @close="showCreate = false"
            @submit="submitCreate" /> -->
        <CreateUserModal v-if="showCreate" :ous="ous" :groups="groups" :users="users"
