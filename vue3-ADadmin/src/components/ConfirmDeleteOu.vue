<template>
    <div v-if="visible" class="mask" @click.self="$emit('cancel')">
        <div class="confirm-box">
            <div class="icon">!</div>
            <div class="title">確定將組織單位刪除？</div>
            <div class="sub" v-if="ou?.ouname">組織單位：{{ ou.ouname }}</div>
...
import type { Ou } from '@/services/adadmin'
defineProps<{ visible: boolean; ou: Ou | null }>()
